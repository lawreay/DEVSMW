...
<head>
    ...
    <title>All profiles - <?= e(config('app_name')) ?></title>
...
<main class="page">
    <section class="search-panel">
        <h1>All developer profiles</h1>
        <p>Browse the complete published list of developer profiles. Use search to filter by name, tech, location, or work.</p>
        <form class="search-form" method="get">
            <input type="search" name="q" value="<?= e($q) ?>" placeholder="Search all profiles...">
